        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Home</a></span> <span>Blog</span></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry blog-entry-2 justify-content-end d-md-flex w-100">
                                <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_1.jpg') }}');"></a>
                                <div class="text pl-md-4 ml-md-2 pt-4">
                                    ...
                                    <h3 class="heading mt-2"><a href="{{ url('/blog-single') }}">Is wellness the new luxury</a></h3>
                                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                                    <p><a href="{{ url('/blog-single') }}" class="btn btn-outline-primary">Learn more</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry blog-entry-2 justify-content-end d-md-flex w-100">
                                <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_2.jpg') }}');"></a>
                                <div class="text pl-md-4 ml-md-2 pt-4">
                                    <div class="meta">
                                        <div><a href="#">Sept. 28, 2019</a></div>
                                        <div><a href="#">Admin</a></div>
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry blog-entry-2 justify-content-end d-md-flex w-100">
                                <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_3.jpg') }}');"></a>
                                <div class="text pl-md-4 ml-md-2 pt-4">
                                    <div class="meta">
                                        <div><a href="#">Sept. 28, 2019</a></div>
                                        <div><a href="#">Admin</a></div>
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry blog-entry-2 justify-content-end d-md-flex w-100">
                                <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_4.jpg') }}');"></a>
                                <div class="text pl-md-4 ml-md-2 pt-4">
                                    <div class="meta">
                                        <div><a href="#">Sept. 28, 2019</a></div>
                                        <div><a href="#">Admin</a></div>
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry blog-entry-2 justify-content-end d-md-flex w-100">
                                <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_5.jpg') }}');"></a>
                                <div class="text pl-md-4 ml-md-2 pt-4">
                                    <div class="meta">
                                        <div><a href="#">Sept. 28, 2019</a></div>
                                        <div><a href="#">Admin</a></div>
