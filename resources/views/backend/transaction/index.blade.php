...
@section('content')
    ...
    <div class="mt-5">
        <div class="relative overflow-x-auto rounded-md bg-white shadow-md">
            <table id="data-table" class="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($transactions as $transaction)
                        <tr class="bg-white border-b border-gray-200">
                            ...
                            <td class="px-6 py-4">{{ $transaction->session }}</td>
            ...
            $(".btn-confirm, .btn-deny").click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.transaction.update', ':id') }}".replace(
                                ':id', transactionID),
