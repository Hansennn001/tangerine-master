    ...
    <div class="bg-white w-1/2 rounded-md shadow-md p-5 mt-5">
        <form action="{{ route('admin.beautician.update', $beautician->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="facebook_link" name="facebook_link" value="{{ $beautician->facebook_link }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-stone-500 focus:border-stone-500 block w-full p-2.5" />
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="instagram_link" name="instagram_link" value="{{ $beautician->instagram_link }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-stone-500 focus:border-stone-500 block w-full p-2.5" />
            </div>
            <div class="mb-5">
                ...
                <input type="text" id="twitter_link" name="twitter_link" value="{{ $beautician->twitter_link }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-stone-500 focus:border-stone-500 block w-full p-2.5" />
            </div>
            <div class="mb-5">
                ...
                <img src="/uploads/beauticians/{{ $beautician->image }}" class="size-20 object-cover rounded-md shadow-md mb-3">
                <input
