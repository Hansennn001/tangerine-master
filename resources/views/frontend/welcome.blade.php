...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-28 bg-stone-100">
        <div class="w-[90%] mx-auto" data-aos="fade-down" data-aos-duration="1000">
            <h1 class="text-4xl text-stone-700 text-center poppins-semibold">Why Tangerine?</h1>
                ...
                <div class="space-y-10 h-fit">
                    <div class="flex gap-5">
                        <div class="text-end h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Our skilled professionals provide high-quality beauty treatments with great care and precision.
                            </p>
                        </div>
                        <div class="h-fit">
                            <i
                    ...
                    <div class="flex gap-5">
                        <div class="text-end h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">We use top-tier beauty products that are safe, effective, and dermatologically tested for the best results.
                            </p>
                        </div>
                        <div class="h-fit">
                            <i
                    ...
                    <div class="flex gap-5">
                        <div class="text-end h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Enjoy a peaceful and luxurious space designed to make you feel comfortable and pampered.
                            </p>
                        </div>
                        <div class="h-fit">
                            <i
                    ...
                    <div class="flex gap-5">
                        <div class="text-end h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Get beauty treatments tailored to your needs, ensuring the best care for your hair and skin.
                            </p>
                        </div>
                        <div class="h-fit">
                            <i
                ...
                <div class="space-y-10 h-fit">
                    <div class="flex gap-5">
                        ...
                        <div class="text-start h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">We prioritize cleanliness and sterilization to maintain a safe and healthy beauty environment.
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        ...
                        <div class="text-start h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Experience modern beauty treatments with advanced techniques to enhance your natural beauty.
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        ...
                        <div class="text-start h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Our friendly staff is dedicated to ensuring a comfortable and satisfying beauty experience.
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        ...
                        <div class="text-start h-fit">
                            ...
                            <p class="text-sm mt-2 text-stone-600">Get high-quality beauty treatments at reasonable prices, making luxury services more accessible.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-28 bg-stone-100">
        <div class="w-[90%] mx-auto">
            ...
            <div class="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-12">
                <img src="/imgs/room/Salon1.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                <img src="/imgs/room/Salon2.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <img src="/imgs/room/Salon3.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                <img src="/imgs/room/Salon4.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                <img src="/imgs/room/Salon5.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <img src="/imgs/room/Salon9.jpg" class="w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                <img src="/imgs/room/Salon7.jpg" class=w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                <img src="/imgs/room/Salon6.jpg" class=w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <img src="/imgs/room/Salon8.jpg" class=w-full h-[300px] object-cover rounded-md shadow-md"
                    data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
