                ...
                <div class="col-12 w-100 text-center">
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item active"><a href="{{ url('/classes') }}" class="nav-link">Classes</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Home</a></span> <span>Classes</span></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-1.jpg') }}');"></a>
                ...
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-2.jpg') }}');"></a>
                        <div class="text w-100 text-center">
                ...
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-3.jpg') }}');"></a>
                        <div class="text w-100 text-center">
                ...
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-4.jpg') }}');"></a>
                        <div class="text w-100 text-center">
                ...
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-5.jpg') }}');"></a>
                        <div class="text w-100 text-center">
                ...
                <div class="col-md-4">
                    <div class="classes w-100 ftco-animate">
                        <a href="#" class="img w-100 mb-3" style="background-image: url('{{ asset('images/classes-6.jpg') }}');"></a>
                        <div class="text w-100 text-center">
