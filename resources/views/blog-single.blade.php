        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Home</a></span> <span class="mr-2"><a href="{{ url('/blog') }}">Blog</a></span> <span>Blog Single</span></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 ftco-animate">
                    ...
                    <div class="about-author d-flex">
                        <div class="bio align-self-md-center mr-5">
                            <img src="{{ asset('images/person_2.jpg') }}" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
