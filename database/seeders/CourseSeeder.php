...
use App\Models\Service; // Changed from Course
use App\Models\ServiceDetail; // Changed from CourseDetail
...
class CourseSeeder extends Seeder
{
    ...
    {
        $newService = Service::create([ // Changed from Course
        ...
        ServiceDetail::create([ // Changed from CourseDetail
            "course_id" => $newService->id, // Changed from course_id
            "name" => "Private Class",
